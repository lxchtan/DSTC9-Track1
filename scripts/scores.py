...
class Metric:
  ...
  def scores(self):
    ...
    generation_bertscore_P_p, generation_bertscore_P_r, generation_bertscore_P_f = self._compute(self._generation_bertscore_P)
    generation_bertscore_R_p, generation_bertscore_R_r, generation_bertscore_R_f = self._compute(self._generation_bertscore_R)
    generation_bertscore_F_p, generation_bertscore_F_r, generation_bertscore_F_f = self._compute(self._generation_bertscore_F)
